        ...
        prompt: function prompt() {
          ...
          return new Dialog$1(app, {
            ...
            destroyOnClose: destroyOnClose,
				...
				presentValue: function presentValue() {
          var assign;
          ...
          var title = args[1];
					var value = args[2];
          var callbackOk = args[3];
          var callbackCancel = args[4];
          if (typeof args[1] === 'function') {
            (assign = args, text = assign[0], callbackOk = assign[1], callbackCancel = assign[2], title = assign[3], title = assign[4]);
          }
          return new Dialog$1(app, {
            title: typeof title === 'undefined' ? defaultDialogTitle : title,
            text: text,
            content: '<div class="dialog-input-field item-input"><div class="item-input-wrap"><input type="text" value="' + value + '" class="dialog-input"></div></div>',
            buttons: [
              {
                text: app.params.dialog.buttonCancel,
              },
